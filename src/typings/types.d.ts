...
import { ClientEvents, Message, PermissionResolvable, RoleResolvable, CommandInteraction, ApplicationCommandOptionData } from 'discord.js';
...
export interface Command {
     ...
     */
    execute: (message: Message, args?: string[], client?: DiscordScanner) => Promise<Message | void>;
}
...
export interface SlashCommand {
     ...
     */
    execute: (interaction: CommandInteraction, client?: DiscordScanner) => Promise<APIMessage | Message | void>;
}
